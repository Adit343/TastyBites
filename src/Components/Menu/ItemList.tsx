...
const ItemList: React.FC<ItemListProps> = ({ items }) => {
  ...
  return (
    <div>
      {items.map((item, idx) => (
        <div
          key={(item.card.info.id || idx) + "-" + idx}
          className="p-2 m-2 border-gray-200 border-b-2 flex flex-col md:flex-row justify-between text-left"
        >
          ...
          <div className="md:w-3/12 p-4 flex flex-col items-center">
            ...
            <button
              className="p-1 px-3 rounded-lg bg-black text-white shadow-lg mt-2 md:mt-0 hover:bg-gray-800"
